...
const adicionarRegistro = require('./adicionar');
const listarRegistros = require('./listar');
const atualizarRegistro = require('./atualizar');
const removerRegistro = require('./remover');
